import {ILoginActions, ISwitchPageActions, LoginActions, SwitchPageAction } from "./Actions";
import { IAppState, initialState } from "./State";

export const Reducer = (state:IAppState = initialState, action: ILoginActions|ISwitchPageActions):IAppState =>{
